...
p.turn = function(dir) {
    ...
    if (carImage) {
        // Define el ángulo máximo de rotación que quieres permitir para el auto
        var maxAngle = 15; // Grados

        // Calcula el nuevo ángulo basado en `dir`, ajustando `currentAngle` gradualmente
        var targetAngle = dir * maxAngle; // El ángulo objetivo basado en la dirección
        currentAngle += (targetAngle - currentAngle) * 0.1; // Ajusta el ángulo suavemente

        // Aplica el ángulo actual al estilo del auto
